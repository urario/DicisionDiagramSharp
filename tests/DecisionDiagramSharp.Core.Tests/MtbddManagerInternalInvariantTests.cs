...
/// <summary>
/// White-box internal invariant tests for MtbddManager.
...
public sealed class MtbddManagerInternalInvariantTests
{
    /// <summary>
    ...
    /// </remarks>
    [TestMethod]
    public void Mtbdd_SizeLimitAndCorruptedStateValidation_Throw()
    {
        ...
        // Arrange / Act / Assert — equal children (white-box corruption)
    ...
    /// </remarks>
    [TestMethod]
    public void Mtbdd_PrivateKeyTypes_ObjectEqualsAndHashCode_Work()
    {
        // Arrange
