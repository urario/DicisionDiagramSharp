...
/// <summary>
/// Immutable diagnostics view of a reachable BDD node.
/// </summary>
public readonly struct BddNodeView
{
    /// <summary>
    /// Initializes a new instance of the <see cref="BddNodeView"/> struct.
    /// </summary>
    public BddNodeView(int nodeId, VariableId variable, int lowNodeId, int highNodeId)
    {
        NodeId = nodeId;
        Variable = variable;
        LowNodeId = lowNodeId;
